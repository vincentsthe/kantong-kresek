...
class Accounting extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('kode, transaksi', 'required'),
			array('kode, transaksi', 'numerical', 'integerOnly'=>true),
			array('pesan', 'length', 'max'=>512),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, kode, pesan, transaksi', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'kode0' => array(self::BELONGS_TO, 'KodeAccounting', 'kode'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('transaksi',$this->transaksi);
